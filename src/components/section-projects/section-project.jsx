...
export function SectionProjects () {
  return (
    ...
    <h2 className="text-4xl sm:text-5xl text-center font-bold">Project</h2>
    <div className="flex flex-col gap-3">
      <h3 className="text-2xl sm:text-3xl font-bold">Tienda DAKA</h3>
      <p className="text-[14px] sm:text-[18px]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Sint reprehenderit impedit dolores voluptatem, necessitatibus quas ad deleniti sed dolorum eum ipsam aliquid natus iure adipisci explicabo animi veritatis maxime numquam.</p>
